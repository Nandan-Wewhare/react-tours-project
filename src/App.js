  ...
  return (
    <>
      ...
      <City
        ...
        price="$2599"
        description="Paris is synonymous with the finest things that culture can offer — in
        ...
        neighborhood walks through the city historic heart as well as
        quieter moments to slow down and savor the city intimate cafés
      ...
      <City
        ...
        price="$3599"
        description="Rick Steves' Best of Ireland tour kicks off with the best of Dublin, 
        followed by Ireland's must-see historical sites, charming towns, music-filled pubs, 
        and seaside getaways — including Kinsale, the Dingle Peninsula, the Cliffs of Moher, 
        the Aran Islands, Galway, Connemara, Giant's Causeway, and the compelling city of Belfast. 
        All along the way, Rick's guides will share their stories to draw you in to the Emerald Isle, 
        and the friendliness of the people will surely steal your heart. Join us for the Best of Ireland in 14 Days!"
      />
      <City
        image={
        ...
        price="$2599"
        description="Let's go where classical music, towering castles, and the-hills-are-alive 
        scenery welcome you to the gemütlichkeit of Bavaria and opulence of Austria's Golden Age. 
        Your Rick Steves guide will bring this region's rich history and culture to life in festive Munich,
         ...
         with cozy villages and alpine vistas all along the way. Join us for the Best of Munich, 
